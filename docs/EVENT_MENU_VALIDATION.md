...
- Reports and GitHub Issues actions require a user click. The confirmation page opens `https://github.com/CapacityDown/StageFlux/issues/new` without including report data in the URL. No report upload occurs. The repository is public; filing an issue requires a GitHub account.
